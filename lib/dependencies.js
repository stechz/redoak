  ...
  'css': function(fileObj, data) {
    ...
    function doStyles(prefix, style) {
      return ['{', _(style).map(function(name) {
        ...
        if (name == 'background-image' || name == 'background') {
          ...
          var atoms = ['translate', 'translateX', 'translateY',
                       'skew', 'skewX', 'skewY', 'rotate',
                       'scale', 'scaleX', 'scaleY'];
    ...
    var text = _(stylesheet.cssRules).map(function doRule(rule) {
      if (rule.kind == '@keyframes') {
        ...
        return ['@-moz-keyframes', insideText('-moz-'),
                '@-webkit-keyframes', insideText('-webkit-'),
                '@-ms-keyframes', insideText('-ms-'),
                '@-o-keyframes', insideText('-o-'),
                '@keyframes', insideText('')];
