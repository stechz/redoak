...
exports.Middleware = function(opts) {
  ...
  if (opts && opts.app) {
    ...
    opts.app.get('/redoak/widget.js', this.get(dirname + 'widget.js'));
...
exports.Middleware.prototype = {
  ...
  produceText_: function(filename, onOak) {
    var tree;
    if (filename) {
  ...
  html: function(filename) {
    return this.produceText_(filename, function(tree) {
      var data = tree.data();
      var fileObjMap = this.fileObjMap_.bind(this, tree);
      if (data.error) {
        return data.error.stack;
      } else {
  ...
  js: function(filename) {
    return this.produceText_(filename, function(tree) {
      var fileObjMap = this.fileObjMap_.bind(this, tree);
      var data = tree.data();
      return render.jsText(
          tree, fileObjMap, data.index, 'localhost:3000');
    }.bind(this));
  },
  ...
  css: function(filename) {
    return this.produceText_(filename, function(tree) {
      var fileObjMap = this.fileObjMap_.bind(this, tree);
      return render.cssText(tree, fileObjMap);
    }.bind(this));
  },
