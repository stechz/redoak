...
function walk(selectors, topjson, escapefn) {
  ...
  var result = (function walk(state, json) {
...
var data = require('fs').readFileSync(require('path').resolve(__dirname, '..', 'templates', 'fill.wjs'), 'utf-8');
